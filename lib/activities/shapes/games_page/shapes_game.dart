...
class _ShapesGameState extends State<ShapesGame> {
  ...
  void setOneWrongNumber(){
    ...
    wrongShapes = [(shapes[randomNumber2].toLowerCase())];
  }
  ...
  void setTwoWrongNumbers(){
    ...
    wrongShapes = [(shapes[randomNumber2].toLowerCase()), (shapes[randomNumber3].toLowerCase())];
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (totalSteps % 3 == 1 && totalSteps <= 10) {
      currentActivity = TapComponent(onCompleted: nextStep, assetLink: shapes[randomNumber].toLowerCase(), mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, totalSteps: totalSteps, directory: "assets/shapes_images/", objectVariation: "Shape",);
    } 
    else if (totalSteps % 3 == 2 && totalSteps < 10) {
      currentActivity = DragDropComponent(onCompleted: nextStep, assetLink: shapes[randomNumber].toLowerCase(), mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, totalSteps: totalSteps, directory: "assets/shapes_images/", objectVariation: "Shape",);
    } 
    else if(totalSteps % 3 == 0 && totalSteps < 10){
      currentActivity = TraceComponent(onCompleted: nextStep, mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, objectVariation: "Shape",);
    } 
    else if(totalSteps % 3 == 1 && totalSteps >= 10){
      currentActivity = TapMultipleObjectsComponent(onCompleted: nextStep, correctAssetLink: shapes[randomNumber].toLowerCase(), wrongAssetLinks: wrongShapes, mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, onIncorrectAction: triggerIncorrectFlash, directory: "assets/shapes_images/", objectVariation: "Shape",);
    }
    else if(totalSteps % 3 == 2 && totalSteps >= 10){
      currentActivity = DragDropMultipleObjectsComponent(onCompleted: nextStep, correctAssetLinks: shapes[randomNumber].toLowerCase(), wrongAssetLinks: wrongShapes, mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, onIncorrectAction: triggerIncorrectFlash, directory: "assets/shapes_images/", objectVariation: "Shape",);
    } 
    else {
      currentActivity = TraceComponent(onCompleted: nextStep, mainData: shapes[randomNumber], onCorrectAction: triggerCorrectFlash, objectVariation: "Shape",);
    }
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Center(child: Text("Shapes", style: GoogleFonts.ubuntu(fontSize:24, fontWeight: FontWeight.bold, color: Colors.white))),
