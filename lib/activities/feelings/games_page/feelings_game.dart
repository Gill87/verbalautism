...
class _FeelingsGameState extends State<FeelingsGame> {
  ...
  void initState() {
    ...
    if(widget.selectedFeeling.isNotEmpty) {
  ...
  void setOneWrongNumber(){
    ...
    wrongObjects = [feelings[randomNumber2].toLowerCase()];
  }

  void setTwoWrongNumbers(){
    randomNumber2 = random.nextInt(feelings.length);
    randomNumber3 = random.nextInt(feelings.length);
    ...
    wrongObjects = [feelings[randomNumber2].toLowerCase(), feelings[randomNumber3].toLowerCase()];
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (totalSteps % 2 == 1 && totalSteps <= 10) {
      currentActivity = TapComponent(onCompleted: nextStep, assetLink: feelings[randomNumber].toLowerCase(), mainData: feelings[correctIndex], onCorrectAction: triggerCorrectFlash, totalSteps: totalSteps, directory: "assets/feelings_images/", objectVariation: "Feeling",);
    } 
    else if (totalSteps % 2 == 0 && totalSteps <= 10) {
      currentActivity = DragDropComponent(onCompleted: nextStep, assetLink: feelings[randomNumber].toLowerCase(), mainData: feelings[correctIndex], onCorrectAction: triggerCorrectFlash, totalSteps: totalSteps, directory: "assets/feelings_images/", objectVariation: "Feeling",);
    } 
    else if(totalSteps % 2 == 1 && totalSteps >= 10){
      currentActivity = TapMultipleObjectsComponent(onCompleted: nextStep, correctAssetLink: feelings[correctIndex].toLowerCase(), wrongAssetLinks: wrongObjects, mainData: feelings[correctIndex], onCorrectAction: triggerCorrectFlash, onIncorrectAction: triggerIncorrectFlash, directory: "assets/feelings_images/", objectVariation: "Feeling",);
    }
    else {
      currentActivity = DragDropMultipleObjectsComponent(onCompleted: nextStep, correctAssetLinks: feelings[correctIndex].toLowerCase(), wrongAssetLinks: wrongObjects, mainData: feelings[correctIndex], onCorrectAction: triggerCorrectFlash, onIncorrectAction: triggerIncorrectFlash, directory: "assets/feelings_images/", objectVariation: "Feeling",);
    }
